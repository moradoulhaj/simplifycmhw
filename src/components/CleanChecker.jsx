...
import { checkCleanLogs, checkLogs } from "../scripts/checker"; // Adjust the import path based on your folder structure
...
export default function CleanChecker() {
  ...
  useEffect(() => {
    ...
    const result = checkCleanLogs(profiles, logs);
    setResult(result);
    setSent(true);
